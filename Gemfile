...
group :development, :test do
  ...
  gem 'launchy','2.1.2' 					# ??
  gem 'autotest','4.4.6' 					# Automatically select and run RSpec tests on change
  gem 'ZenTest','4.4.1' 					# Automatically select and run RSpec tests on change
  gem 'simplecov','0.7.1' 					# Calculates the cucumber test coverage
  gem 'cucumber-rails','1.3.0',:require => false 		# Automated intergration/acceptance testing tool
  gem 'cucumber-rails-training-wheels','1.0.0' 			# Automated intergration/acceptance testing tool
  gem 'rspec-rails','2.12.2' 					# Automated unit/functional testing tool
